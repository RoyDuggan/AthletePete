...
const wrap = (heading: string, body: string, cta: { label: string; url: string }) => `
  <div style="font-family:Arial,Helvetica,sans-serif;max-width:520px;margin:0 auto;color:#1f2937">
    ...
    <p style="font-size:12px;color:#6b7280">— D+R Athletic Development</p>
  </div>`;
...
export async function sendVerificationEmail(
  ...
  await send({
    to,
    subject: "Verify your D+R Athletic Development email address",
    text: `${hi}\n\nThanks for creating your D+R Athletic Development account. Confirm your email address using this link (expires in 24 hours):\n\n${url}\n\nIf you didn't sign up, you can ignore this email.\n\n— D+R Athletic Development`,
    html: wrap(
      "Confirm your email",
      `${hi} thanks for creating your D+R Athletic Development account. Please confirm your email address — this link expires in 24 hours. If you didn't sign up, you can ignore this email.`,
...
export async function sendPasswordResetEmail(
  ...
  await send({
    to,
    subject: "Reset your D+R Athletic Development password",
    text: `${hi}\n\nWe received a request to reset your D+R Athletic Development password. Choose a new one using this link (expires in 1 hour):\n\n${url}\n\nIf you didn't request this, no action is needed and your password stays the same.\n\n— D+R Athletic Development`,
    html: wrap(
      "Reset your password",
      `${hi} we received a request to reset your D+R Athletic Development password. This link expires in 1 hour. If you didn't request this, no action is needed and your password stays the same.`,
